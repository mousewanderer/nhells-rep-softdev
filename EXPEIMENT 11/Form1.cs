...
namespace EXP11
{
    public partial class Form1 : Form
    {
        ...
        string connectionString = "Server=ASUS_2023;Database=junilostudentsDB;Trusted_Connection=True";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            CourseBox.Items.Add("Industrial technology");
        ...
        private bool IsValidAge(int age)
        {
            if (age >= 150)
            {
                MessageBox.Show("Unrealistic Older");
                txtAge.Text = "";
                return false;
            }
            else if (age <= 0)
